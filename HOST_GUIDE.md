# Majority Rules - Host Guide

## What is Majority Rules?

**Majority Rules** is a fast-paced social game where players win by predicting what the majority will choose—not by being "right." Players vote on subjective questions, use a confidence slider to decide their risk level, and earn points by matching the crowd. It's psychology meets strategy.

---

## Who Should Host This?

Anyone running a group activity! Teachers, team leaders, event organizers, party hosts—if you have 5+ people and 30 minutes, you can run this game.

---

## When Does It Work Best?

- 🏫 **Classroom icebreakers** - Get students talking about subjective topics
- 👔 **Team building** - Break down assumptions about what teammates think
- 🎉 **Parties & events** - Fun, competitive social activity
- 💬 **Online meetings** - Virtual team engagement
- 🏢 **Corporate workshops** - Discussion starter on creative/innovation topics
...
2. Players have **30 seconds** to vote and set their confidence
   ...
   - Middle (1x): Normal—earn points or lose points equally
   - Right (3x): Risky—triple points if right, triple penalty if wrong
3. Click **"Reveal Results"** to show vote breakdown and scores
4. View the presenter screen to see the vote visualization
...
✅ **Test with a friend** - Make sure you understand the flow before hosting a large group  
✅ **Mix question types** - Combine AI-generated (fun, silly) with custom questions (relevant to your group)  
✅ **Use the presenter screen** - Display it so everyone watches results together  
✅ **Read aloud** - Announce the question and options so players without great wifi can participate  
✅ **Pause between rounds** - Give host time to select the next question and set the mood  
✅ **Explain confidence** - First-time players often use "Normal" by default—mention the risk/reward trade-off
